...
class UpdateViewModel @Inject constructor(
    ...
    fun checkUpdates() {
        ...
        viewModelScope.launch {
            ...
            updateConfig?.let {
                if (updateConfigRepository.newUpdateAvailable(it.buildDateUTC)) {
                    _updateConfig.value = it
    ...
    private fun getLastCheck(): String {
        ...
        return sharedPreferences.getString("last_check", notAvailable) ?: notAvailable
    }
    ...
    private fun setLastCheck(): String {
        ...
        sharedPreferences.edit { putString(CommonModule.lastCheck, date) }
        return date
    }
}
