...
public class MainActivity extends AppCompatActivity {
    ...
    private CircularProgressIndicator mUpdateCheckProgressBar;
    private LinearLayout mUpdateInfoContainer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Date securityVersionDate = simpleDateFormat.parse(Build.VERSION.SECURITY_PATCH);
            java.text.DateFormat dateFormat = DateFormat.getLongDateFormat(this);
            securityVersion.setText(
                    getString(R.string.security_version, dateFormat.format(securityVersionDate))
            );
        } catch (Exception exception) {
            Log.d(TAG, "Caught an exception: " + exception.getMessage());
        }
        ...
        mUpdateCheckProgressBar = findViewById(R.id.update_check_progress_bar);
        mUpdateInfoContainer = findViewById(R.id.update_info_container);
        ...
        mMultiButton.setOnClickListener(v -> {
            mUpdateTitle.setText(R.string.checking_updates);
            mUpdateInfoContainer.setVisibility(View.GONE);
            mMultiButton.setVisibility(View.GONE);
            mSettings.setVisibility(View.GONE);
            mUpdateCheckProgressBar.setVisibility(View.VISIBLE);
            loadUpdateConfig();
        });
        ...
        protected void onPostExecute(UpdateConfig updateConfig) {
            ...
            runOnUiThread(() -> {
                ...
                if (updateConfig != null) {
                    ...
                    mUpdateTitle.setText(R.string.uptodate);
                    mUpdateInfoContainer.setVisibility(View.VISIBLE);
                    mUpdateCheckProgressBar.setVisibility(View.GONE);
